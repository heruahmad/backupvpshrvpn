...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/heruahmad1/v4/main/tem/nginx.conf" 
#mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/heruahmad1/v4/main/tem/vps.conf"
